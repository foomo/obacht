    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'APT', link: '/rules/apt' },
          { text: 'Brew', link: '/rules/brew' },
          { text: 'Bumblebee', link: '/rules/bumblebee' },
          { text: 'Bun', link: '/rules/bun' },
          { text: 'Claude Code', link: '/rules/claude-code' },
