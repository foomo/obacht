...
Bouncer includes 53 built-in rules across 11 categories.
...
| OS018 | OS | No EDR agent deployed | critical |
| OS019 | OS | Legacy kernel extensions are not blocked | high |
...
| PRV003 | Privacy | Encrypted DNS is not configured | info |
