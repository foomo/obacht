...
claude_skip_if_missing CLD036

# Required permissions.deny entries for network/exfiltration tools.
required='Bash(nc:*)
Bash(netcat:*)
Bash(socat:*)
Bash(ssh:*)
...
jq -cn --arg v "$missing" '{permissions_deny_network_missing: $v}' | emit_ok CLD036
